...
export function array_to_int(l) {
	var x = 0;
...
export function newHashToInteger(h) {
	function hash2integer2(h, i, n) {
		var x = h[i];
		if  ( x == 0 ) {
			return hash2integer2(h, i+1, n+(256*8));
...
export function list_to_uint8(l) {
...
export function serializeHeader(x) {
